...
https://github.com/neilberkman/ueberauth_docusign/security/advisories/new
...
[Hex](https://hex.pm/packages/ueberauth_docusign). Please upgrade to the latest version before
reporting an issue.
